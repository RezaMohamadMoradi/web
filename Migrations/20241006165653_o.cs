        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_products_Categuries_categuryid",
            ...
            migrationBuilder.InsertData(
                table: "products",
                columns: new[] { "id", "Description", "Name", "categuryid", "img", "itemid" },
                values: new object[,]
                {
                    { 1, "از مقدماتی تا حرفه ای", "دوره C#", 1, "~/Img/1.jpg", 1 },
                    { 2, "از مقدماتی تا حرفه ای", "دوره php", 2, "~/Img/2.jpg", 2 },
                    { 3, "از مقدماتی تا حرفه ای", "دوره java", 1, "~/Img/3.jpg", 3 }
                });
